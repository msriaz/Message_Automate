...
export const addComponentExample = (title, usage = () => { }) => { if (DebugConfig.includeExamples || 1) globalComponentExamplesRegistry.push({ title, usage }) } // eslint-disable-line

export const addPluginExample = (title, usage = () => { }) => { if (DebugConfig.includeExamples || 1) globalPluginExamplesRegistry.push({ title, usage }) } // eslint-disable-line
